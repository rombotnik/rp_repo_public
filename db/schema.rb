...
ActiveRecord::Schema.define(version: 20180723211509) do
  ...
  create_table "story_roles", force: :cascade do |t|
    t.bigint "character_id"
    t.bigint "story_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["character_id"], name: "index_story_roles_on_character_id"
    t.index ["story_id"], name: "index_story_roles_on_story_id"
  end
  ...
  add_foreign_key "notes", "stories"
  add_foreign_key "posts", "scenes"
  add_foreign_key "posts", "users"
  add_foreign_key "scenes", "stories"
  add_foreign_key "stories", "genres"
  add_foreign_key "story_roles", "characters"
  add_foreign_key "story_roles", "stories"
end
